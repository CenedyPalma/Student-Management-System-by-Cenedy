...
<div class="box bb-3 border-warning">
  ...
  <div class="row">  <!-- start 1st row -->
   ...
   <img src="{{ url('upload/IIT.png') }}" style="width: 120px; height: 100px;">			
  		</div>
        ...
        <div class="col-md-2 text-center">
  		...
  		<div class="col-md-4 text-center" style="float: left;">
  			<h4><strong>IITSM</strong></h4>
  			<h6><strong>University of Dhaka </strong></h6>
...
<div class="row"> <!--  6th row start -->
  <div class="col-md-4">
    ...
    <div class="text-center">Co-ordinator</div>
  </div>

    <div class="col-md-4">
  <hr style="border: solid 1px; widows: 60%; color: #ffffff; margin-bottom: -3px;">
    <div class="text-center">Chairman </div>
  </div>
